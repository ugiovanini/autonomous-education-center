...
export const disciplines: Discipline[] = [
  ...
  },
  {
    slug: "projetos",
    name: "Projetos",
    description: "Gerenciamento de projetos com base no PMBOK: integração, escopo, cronograma, custos, qualidade, recursos, comunicações, riscos, aquisições e partes interessadas",
    courseCount: 10,
  ...
  },
  {
    slug: "servicos",
    name: "Serviços",
    description: "Práticas de gerenciamento geral, de serviços e técnicas para gestão de TI e operações",
    courseCount: 34,
